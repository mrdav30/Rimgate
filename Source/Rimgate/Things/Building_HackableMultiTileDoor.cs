...
public class Building_HackableMultiTileDoor : Building_HackableSingleDoor
{
    ...
    private static readonly float UpperMoverAltitude = AltitudeLayer.DoorMoveable.AltitudeFor() + 0.0182926841f;
    ...
    protected override void DrawAt(Vector3 drawLoc, bool flip = false)
    {
        ...
        if (!tmpStuckOpen)
        {
            float offsetDist = 0.25f + 0.350000024f * OpenPct;
            ...
            {
                float offsetDist2 = 0.25f + 0.350000024f * Mathf.Clamp01(OpenPct * 2.5f);
